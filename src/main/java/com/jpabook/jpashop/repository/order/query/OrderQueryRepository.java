...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findAllByDto_optimiztion() {
        ...
        result.forEach(o -> {
            o.setOrderItems(orderItemMap.get(o.getId()));
        });
        return result;
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery(
                        "select new com.jpabook.jpashop.repository.order.query.OrderFlatDto(o.id,m.name,o.orderDate,o.status,d.address,i.name,oi.orderPrice,oi.count) from Order o " +
                                "join o.member m " +
                                "join o.delivery d " +
